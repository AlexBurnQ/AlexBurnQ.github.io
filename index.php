  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="container">
        <div class="main-title">
          <h2>Что такое <span>BurnCash</span></h2>
        </div>
        <div class="main-content">
          ...
          <p><span>BurnCash</span>, первый и единственный сервис в рунете, способный предоставлять Qiwi кошельки вместе с дубликатами сим-карт, на которые они зарегистрированы, и готовностью отправить их Вам наложенным платежом, с оплатой при получении!</p>
          <p>К тому же, <span>BurnCash</span>, не является коммерческим проектом, и Вы оплачиваете только работу наших партнеров по изготовлению дубликатов сим-карт!</p>
        </div>
      </div>
    </main>
    	...
    	<div class="container">
    		...
    		<div class="feature-content">
					...
					<div class="oneA">
						...
						<div class="feature-text">
							<p>Вы можете заказать кошелек, выбрав удобный для Вас способ доставки сим-карты транспортными компаниями:</p>
							<p><a href="https://www.dellin.ru/" target="_blank">Деловые линии</a>, <a href="https://www.cdek.ru" target="_blank">СДЭК</a>, <a href="https://www.dhl.ru" target="_blank">DHL</a> или наложенным платежом почты РФ с оплатой при получении.</p>
							<p>Стоимость и сроки доставки рассчитываются по внутренним тарифам ТК или почты РФ.</p>
						</div>
						<div class="lineTop"></div>
						<div class="lineRight"></div>
						<div class="lineBottom"></div>
    ...
    <section class="instruction">
    	<div class="container">
          ...
          <iframe class="video" src="https://www.youtube.com/embed/ole6vR-BFGw" allowfullscreen></iframe>
    		</div>
        <p class="video-text"><span class="red">*</span> Видео руководство является примером и не нарушает действующих законов РФ.</p>
    	</div>
    </section>
    <section class="step">
    	<div class="container">
        ...
        <div class="modal">
          <div class="popup js-thank-you">
            ...
            <div class="close-popup js-close-thank-you"></div>
    	  	...
    	  	<div align="center" class="form-block">
    		<footer>
		...
		<div class="form-container">
			...
			<div class="fields">
				<form class="ajax-contact-form" action="">
					...
					<div class="row">
						<div class="col"><input type="tel" name="tel" value="" placeholder="Телеграмм"></div>
    ...
    <!-- Интеллектуальная собственность baezgamer -->
